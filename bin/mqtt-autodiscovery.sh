...
# Controls
mqtt_publish "${DISCOVERY_PREFIX}/switch/${NODE_ID}/floodlight/config" "{\"name\": \"${NODE_ID} Floodlight\", \"unique_id\": \"${NODE_ID}-floodlight\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:track-light\", \"state_topic\": \"${TOPIC_BASE}/lights/floodlight\", \"command_topic\": \"${TOPIC_BASE}/lights/floodlight/set\"}"
