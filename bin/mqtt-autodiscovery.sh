...
# Controls
mqtt_publish "${DISCOVERY_PREFIX}/switch/${NODE_ID}/spotlight/config" "{\"name\": \"${NODE_ID} Spotlight\", \"unique_id\": \"${NODE_ID}-spotlight\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:track-light\", \"state_topic\": \"${TOPIC_BASE}/lights/spotlight\", \"command_topic\": \"${TOPIC_BASE}/lights/spotlight/set\"}"
