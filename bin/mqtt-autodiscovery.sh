...
# Controls
mqtt_publish "${DISCOVERY_PREFIX}/switch/${NODE_ID}/floodlight/config" "{\"name\": \"${NODE_ID} Floodlight\", \"unique_id\": \"${NODE_ID}-floodlight\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:lightbulb-on\", \"state_topic\": \"${TOPIC_BASE}/floodlight\", \"command_topic\": \"${TOPIC_BASE}/floodlight/set\"}"
