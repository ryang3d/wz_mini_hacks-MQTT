...
# Controls
mqtt_publish "${DISCOVERY_PREFIX}/light/${NODE_ID}/floodlight_on/config" "{\"name\": \"${NODE_ID} Floodlight On\", \"unique_id\": \"${NODE_ID}-floodlight-on\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:lightbulb-on\", \"state_topic\": \"${TOPIC_BASE}/floodlight_on\", \"command_topic\": \"${TOPIC_BASE}/floodlight_on/set\"}"
mqtt_publish "${DISCOVERY_PREFIX}/light/${NODE_ID}/floodlight_off/config" "{\"name\": \"${NODE_ID} Floodlight Off\", \"unique_id\": \"${NODE_ID}-floodlight-off\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:lightbulb-off\", \"state_topic\": \"${TOPIC_BASE}/floodlight_off\", \"command_topic\": \"${TOPIC_BASE}/floodlight_ff/set\"}"
