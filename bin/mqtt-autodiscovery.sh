...
# Controls
mqtt_publish "${DISCOVERY_PREFIX}/switch/${NODE_ID}/floodlight/config" "{\"name\": \"${NODE_ID} Floodlight\", \"unique_id\": \"${NODE_ID}-floodlight\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:lightbulb-on\", \"state_topic\": \"${TOPIC_BASE}/lights/floodlight\", \"command_topic\": \"${TOPIC_BASE}/lights/floodlight/set\"}"
mqtt_publish "${DISCOVERY_PREFIX}/switch/${NODE_ID}/siren/config" "{\"name\": \"${NODE_ID} Siren\", \"unique_id\": \"${NODE_ID}-siren\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:bullhorn\", \"state_topic\": \"${TOPIC_BASE}/siren\", \"command_topic\": \"${TOPIC_BASE}/siren/set\"}"
